...
import com.example.shopapp.ui.i.adapters.AddressListAdapter
...
class AddressListActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Cambiando título de la barra dependiendo de si hay o no Address
        if (mSelectAddress) {
    ...
    fun successAddressListFromFirestore(addressList: ArrayList<Address>) {
        ...
        if (addressList.size > 0) {
            ...
            //TODO: CREATING THE SWIPE ACTIONS
            if (!mSelectAddress) {
