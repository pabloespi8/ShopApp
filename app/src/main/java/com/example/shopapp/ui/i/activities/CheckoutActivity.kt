...
import com.example.shopapp.ui.i.adapters.CartItemsListAdapter
...
class CheckoutActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //TODO: pasando e introduciendo datos en el layout del intent
    ...
    fun successCartItemsList(cartList: ArrayList<Cart>) {
        ...
        //Revisar si el recycler tiene todos los datos y colocándolos
        ...
        // TODO:Here we have kept Shipping Charge is fixed as $10 but in your case it may cary. Also, it depends on the location and total amount.
        tv_checkout_shipping_charge.text = "$10.0"

        if (mSubTotal > 0) {
            ll_checkout_place_order.visibility = View.VISIBLE

            //TODO: Añadiendo al total los gastos de envío
    ...
    fun allDetailsUpdatedSuccessfully() {
        ...
        hideProgressDialog()
        Toast.makeText(this@CheckoutActivity, "Your order placed successfully.",
